...
#include <sigsegv.h>
typedef stackoverflow_context_t SignalHandler;
#elif defined(__linux__)
typedef struct sigcontext      *SignalHandler;
#else
...
# else
void sigio_handler(int,int,SignalHandler);       /* sktsig.c */
# endif
#else
int main();                                      /* sktsig.c */
...
signal(SIGIO,(void *) sigio_handler);	/* install sigio handler			*/
...
#endif	/* __PROTOTYPE__ */
{
signal(SIGIO,(void *) sigio_handler);	/* re-install sigio handler			*/
