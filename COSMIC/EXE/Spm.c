...
/* --------------------------------------------------------------------- */
/* main: this is where it starts, ladies and gentlemen! {{{2             */
#ifdef __WIN32__
...
/* ----------------------------------------------------------------------     */
/* Sopen_prtmstr: this function opens a socket handle for the Portmaster {{{2 */
...
/* ---------------------------------------------------------------------- */
/* makePortTable: this function allocates, links, sets up a PortTable {{{2 */
#ifdef __PROTOTYPE__
...
/* ---------------------------------------------------------------------- */
/* delPortTable: this function deletes a PortTable {{{2 */
#ifdef __PROTOTYPE__
...
/* ---------------------------------------------------------------------- */
/* pm_server: this function handles the PortMaster Server protocol {{{2 */
#ifdef __PROTOTYPE__
void pm_server(
...
/* ---------------------------------------------------------------------- */
/* pm_client: handle PortMaster client protocol (looks up server port) {{{2 */
#ifdef __PROTOTYPE__
...
/* ---------------------------------------------------------------------- */
/* pm_close: this function handles a server close (removes server from {{{2
 *  PortTable)
 */
#ifdef __PROTOTYPE__
...
/* ---------------------------------------------------------------------- */
/* pm_quit: this function causes the PortMaster to quit (shutdown) {{{2 */
#ifdef __PROTOTYPE__
void pm_quit(
  Socket *server,
  Socket *client)
...
/* ---------------------------------------------------------------------- */
/* pm_table: this function returns the PortMaster's PortTable through the {{{2
 * socket to it
 */
#ifdef __PROTOTYPE__
...
/* ---------------------------------------------------------------------- */
/* pm_rmserver: this function removes a server entry from the PortTable {{{2 */
#ifdef __PROTOTYPE__
...
#ifdef SPMFIREWALL
/* --------------------------------------------------------------------- */
/* firewall: how to keep out unwanted types {{{2
...
/* --------------------------------------------------------------------- */
/* firewall_init: initialize PortMaster firewall {{{2 */
#ifdef __PROTOTYPE__
...
/* --------------------------------------------------------------------- */
/* pm_fwinit: handles PortMaster firewall re-initialize {{{2 */
#ifdef __PROTOTYPE__
